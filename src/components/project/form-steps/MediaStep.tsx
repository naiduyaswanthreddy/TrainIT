        ...
        render={({ field }) => (
          <FormItem>
            <FormLabel className="flex items-center">
              Cover Image <span className="text-amber-500 ml-1">*</span>
              <Tooltip>
                <TooltipTrigger asChild>
                  <HelpCircle className="h-4 w-4 ml-1 text-gray-400" />
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  <p>An image that represents your project. High-quality images increase your chances of getting funded.</p>
                </TooltipContent>
              </Tooltip>
            </FormLabel>
            <FormControl>
            ...
            <FormDescription>
              Upload a high-quality image that represents your project. <span className="text-amber-500">Strongly recommended</span>
            </FormDescription>
            <FormMessage />
          </FormItem>
        )}
